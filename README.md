...
**데이터 관측 기간은 2022-06-23 ~ 2022-12-08(167일, 약 6개월)이다.** 즉 이 프로젝트는 **최신 고객 행동이 아닌
...
> 포착률(Recall)을 21.68% 더 적은 인원으로 달성했다 (Model B, will_purchase_14d).
...
- 동일한 구매 후보 포착률(Recall)을 최근성 규칙 대비 **최대 50.87% 더 적은
  접촉 인원**으로 달성 (Model B, will_purchase_14d, 30% 접촉 구간)
- 구매 비활성 위험 예측은 AUC 기준 규칙보다 통계적으로 우수(0.754 vs
